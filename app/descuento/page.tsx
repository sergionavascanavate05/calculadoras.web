...
const ID = "descuento";
const TITULO = "Calculadora de Descuentos";
const DESCRIPCION = "Calcula el precio final tras uno o varios descuentos y el ahorro real que supone.";
const RUTA = "/descuento";
