...
const ID = "amortizacion";
const TITULO = "Calculadora de Amortización";
const DESCRIPCION = "Genera el cuadro de amortización completo de tu préstamo, cuota a cuota.";
const RUTA = "/amortizacion";
