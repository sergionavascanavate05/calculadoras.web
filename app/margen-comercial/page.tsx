...
const ID = "margen-comercial";
const TITULO = "Calculadora de Margen Comercial";
const DESCRIPCION = "Calcula el margen sobre el precio de venta y el marcaje sobre el coste.";
const RUTA = "/margen-comercial";
