...
import ConsumoCombustibleForm from "./ConsumoCombustibleForm";
...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Calculadora de Consumo de Combustible - Calculadoras Online", description: "Calcula porcentajes al instante." },
};

export default function ConsumoCombustiblePage() {
  return (
    <div className="max-w-content mx-auto px-4 sm:px-6 py-8 sm:py-12">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          <h1 className="font-display font-bold text-2xl sm:text-3xl text-fg tracking-tight" data-od-id="consumo-combustible-heading">Calculadora de Consumo de Combustible</h1>
