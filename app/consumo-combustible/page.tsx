...
const ID = "consumo-combustible";
const TITULO = "Calculadora de Consumo de Combustible";
const DESCRIPCION = "Calcula el consumo real de tu coche en litros cada 100 km y su coste.";
const RUTA = "/consumo-combustible";
