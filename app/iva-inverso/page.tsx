...
const ID = "iva-inverso";
const TITULO = "Calculadora de IVA Inverso";
const DESCRIPCION = "Extrae la base imponible y la cuota de IVA de un precio que ya lo incluye.";
const RUTA = "/iva-inverso";
