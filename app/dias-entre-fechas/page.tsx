...
const ID = "dias-entre-fechas";
const TITULO = "Calculadora de Días entre Fechas";
const DESCRIPCION = "Calcula los días naturales, laborables y semanas que hay entre dos fechas.";
const RUTA = "/dias-entre-fechas";
