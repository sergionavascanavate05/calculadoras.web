...
import InflacionForm from "./InflacionForm";

export const metadata: Metadata = {
  title: "Calculadora de Inflación",
  description: "Calcula el inflación de cualquier importe al tipo general (21%), reducido (10%) o superreducido (4%). Incluye o excluye el IVA automáticamente.",
  openGraph: { title: "Calculadora de Inflación - Calculadoras Online", description: "Calcula el inflación de cualquier importe. Tipos: general 21%, reducido 10%, superreducido 4%." },
};
  ...
  return (
    <div className="max-w-content mx-auto px-4 sm:px-6 py-8 sm:py-12">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          <h1 className="font-display font-bold text-2xl sm:text-3xl text-fg tracking-tight" data-od-id="inflacion-heading">Calculadora de Inflación</h1>
          <p className="mt-2 text-muted text-sm sm:text-base leading-relaxed">Calcula el inflación de cualquier importe al tipo general, reducido o superreducido. Puedes calcular el inflación incluido o añadirlo al importe base.</p>
        </div>
        <InflacionForm />
